...
export type TExp =  AtomicTExp | CompoundTExp | TVar | UserDefinedNameTExp | SymbolTExp| LitTexp; // L51
export const isTExp = (x: any): x is TExp => isAtomicTExp(x) || isCompoundTExp(x) || isTVar(x) || isUserDefinedNameTExp(x)||isLitTexp(x); // L51
